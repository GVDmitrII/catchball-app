  ...
  return (
    <div className="animate-fade-in py-12 px-4 max-w-4xl mx-auto">
      ...
      <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
        <Card className="p-8 sm:p-10 border-l-4 border-l-brand-magenta">
          <h2 className="text-2xl font-bold text-brand-dark mb-6">{t('rules_page.h2_diff')}</h2>
          <ul className="list-none space-y-4">
            <li className="flex items-start">
              <span className="text-brand-magenta mr-3 mt-1">✔</span>
        ...
        <Card className="p-8 sm:p-10 bg-fuchsia-50 border-0 shadow-none">
          <h2 className="text-2xl font-bold text-brand-dark mb-4">{t('rules_page.h2_ethics')}</h2>
          <p className="mb-4 text-brand-dark/80">{t('rules_page.ethics_desc')}</p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between bg-brand-dark rounded-btn-lg p-8 sm:p-10 text-white shadow-xl mt-12">
          ...
          <Button variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-brand-dark w-full sm:w-auto">
